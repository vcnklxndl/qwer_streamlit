...
page = st.radio(
    "페이지 선택",
    ["🙋‍♂️ 자기소개", "👨‍🚒 장래희망", "🎨취미와 관심사", "🕵️ 성격과 강점", "🧾비전과 각오"],
    horizontal=True,
                ...
                <div style="text-align: center; position: relative;">
                    <div style="position: relative;">
                        <div class="ai-avatar" style="margin-bottom: 2rem;">
                            <i class="fas fa-user" style="color: white; font-size: 3.5rem;"></i>
                        </div>
                    ...
                    <p style="color: #64748b; font-size: 1.1rem; font-weight: 500;">24세 | 건양대학교 3학년 재학중</p>
                    <p style="color: #64748b; font-size: 1.1rem; font-weight: 500;">이메일 |dognwook14161@gmail.com </p>
                    <p style="color: #64748b; font-size: 1.1rem; font-weight: 500;"> |010-4266-7886</p>
                </div>
                <div>
                    <div class="stats-grid">
                        <div class="feature-card">
                            <div class="icon-modern">
                                <i class="fas fa-fire-extinguisher" style="color: white; font-size: 1.5rem;"></i>
                            </div>
                            <h3 style="color: #1e293b; font-size: 1.3rem; font-weight: 700; margin-bottom: 1rem;">꿈</h3>
                            <p style="color: #64748b; margin: 0; font-weight: 500;">소방관</p>
                        </div>
                        <div class="feature-card">
                            <div class="icon-modern">
                                <i class="fas fa-shield-alt" style="color: white; font-size: 1.5rem;"></i>
                            </div>
                            <h3 style="color: #1e293b; font-size: 1.3rem; font-weight: 700; margin-bottom: 1rem;">사명</h3>
                            <p style="color: #64748b; margin: 0; font-weight: 500;">시민의 생명과 재산 보호</p>
                        </div>
                        <div class="feature-card">
                            <div class="icon-modern">
                                <i class="fas fa-heart" style="color: white; font-size: 1.5rem;"></i>
                            </div>
                            <h3 style="color: #1e293b; font-size: 1.3rem; font-weight: 700; margin-bottom: 1rem;">신념</h3>
                            <p style="color: #64748b; margin: 0; font-weight: 500;">끊임없는 도전과 성장</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="quote-modern" style="margin-top: 3rem;">
                <p style="font-size: 1.6rem; font-weight: 600; margin: 0; text-align: center;">
                    꿈을 향한 끊임없는 도전과 성장
                </p>
            </div>
        </div>
            ...
            <div class="card">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 3rem; align-items: center;">
                    <div style="space-y: 2rem;">
                        <div class="card-hover" style="background: linear-gradient(to right, #fef2f2, #fff7ed); padding: 1.5rem; border-radius: 1rem;">
                            <div style="display: flex; align-items: center; margin-bottom: 1rem;">
                                ...
                                <h3 style="font-size: 1.5rem; font-weight: bold; color: #2d3748;">나의 꿈
                            </div>
                        ...
                        <div class="card-hover" style="background: linear-gradient(to right, #eff6ff, #ecfeff); padding: 1.5rem; border-radius: 1rem;">
                            <div style="display: flex; align-items: center; margin-bottom: 1rem;">
                            ...
                            <p style="color: #4b5563; font-size: 1.125rem; line-height: 1.75;">
                                두려움을 무릎쓰고 누군가의 <span style="font-weight: 600; color: #3b82f6;">생명을 지키는</span> 그 모습은<br>
                                제 마음 깊은 곳에 각인 되었습니다
                            </p>
                        </div>
                    ...
                    <div style="display: flex; flex-direction: column; align-items: center;">
                        ...
                        <div style="text-align: center; background: linear-gradient(to right, #f9fafb, #eff6ff); padding: 1.5rem; border-radius: 1rem; box-shadow: 0 20px 40px rgba(0,0,0,0.1);">
                            ...
                            <p style="font-size: 1.125rem; color: #4b5563; font-weight: 500;">
                                "언제 어떤  상황이 와도 시민을 지킬 수 있도록 늘 준비된 사람이 되겠습니다. "누군가에게는 전부일 그 순간, 제가 그 희망이 되고 싶습니다."</strong>"
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="main">
            <div class="card">
                <div style="text-align: center; margin-bottom: 2rem;">
                    <h1 style="font-size: 2.5rem; font-weight: bold; color: #2d3748;">취미와 관심사</h1>
                    ...
                    <div style="space-y: 1.5rem;">
                        ...
                        <div class="card-hover" style="background: linear-gradient(to right, #fef2f2, #fce7f3); padding: 1.25rem; border-radius: 0.75rem; margin-bottom: 1.5rem;">
                            <div style="display: flex; align-items: center; margin-bottom: 0.75rem;">
                                ...
                                <h3 style="font-size: 1.25rem; font-weight: bold; color: #2d3748;">소방 전문 학습</h3>
                            </div>
                            <p style="color: #4b5563; line-height: 1.75;">
                                재난안전, 소방학개론, 구급법,<br>
     ...
     st.markdown("""
        <div class="main">
            <div class="card">
                ...
                <div style="text-align: center; margin-top: 1.5rem; background: linear-gradient(to right, #f9fafb, #fee2e2); padding: 1.25rem; border-radius: 1rem;">
                    <h4 style="font-size: 1.5rem; font-weight: bold; color: #2d3748; margin-bottom: 0.5rem;">
                        <i class="fas fa-quote-left" style="color: #ef4444; margin-right: 0.5rem;"></i>
                        나의 가치관
                        <i class="fas fa-quote-right" style="color: #ef4444; margin-left: 0.5rem;"></i>
                    </h4>
                    <p style="font-size: 1.25rem; color: #2d3749; font-weight: 500;">어려움에 처한 타인에 대한 공감 능력을 가지고 봉사하는 자세를 가질것입니다.</h4>
                </div>
            </div>
        </div>
    """, unsafe_allow_html=True)